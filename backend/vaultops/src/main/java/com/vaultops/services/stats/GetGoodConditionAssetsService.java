...
@Service
public class GetGoodConditionAssetsService implements Query<Void, Integer> {
    ...
    public ResponseEntity<Integer> execute(Void input) {
        Integer count = assetRepository.countAssetsByConditionStatus(ConditionStatus.GOOD);
